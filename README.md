...
8. 証明書の種類と識別子と発行者
    ...
    |ID|名称|英名|発行者|識別子|
    | :- | :- | :- | :- | :- |
    |1|認証用<br>証明書|User<br>Authentication<br>Certificate|||
    |2|署名用<br>証明書|Digital<br>Signature<br>Certificate|||
    |3|認証用<br>CA証明書|User<br>Authentication<br>Certificate<br>CA|||
    |4|署名用<br>CA証明書|Digital<br>Signature<br>Certificate<br>CA|||
